const WhatDrivesUs = () => {
  ...
  return (
    <section className="bg-[#F0F0F0] border-t border-[#F0F0F0]">
      <div className="max-w-[1280px] px-8 py-24 mx-auto max-lg:py-16 max-md:px-4">
        <h3 className="text-center text-4xl font-bold text-[#262626] mb-20 font-onest max-md:text-2xl max-md:mb-10">
          What Drives Us?
        </h3>
        ...
        <div className="grid grid-cols-2 gap-6 max-md:grid-cols-1">
          {data.map((item, i) => {
            return (
              <div key={i} className="rounded-2xl bg-[#823734]">
                <p className="text-lg font-bold text-white py-4 px-6 rounded-tl-[16px] rounded-tr-[16px] font-geist">
                  {item?.heading}
                </p>
                <p className="text-lg text-white px-6 pt-6  bg-[#A84743] h-[200px] rounded-2xl font-geist max-lg:h-[230px] max-lg:pb-6 max-lg:text-base max-md:pb-4">
                  {item?.subhead}
                </p>
              </div>
            );
