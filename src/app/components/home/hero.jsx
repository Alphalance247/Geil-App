const Hero = () => {
  return (
    <section className="bg-[#141414]">
      <div className="relative bg-[url('/assets/image/heroImg.png')] max-w-[1430px] h-[866px] py-[12rem] mx-auto bg-no-repeat bg-cover bg-center max-xl:h-[600px] max-lg:h-[500px] max-md:h-[350px]">
        <div className="absolute w-full inset-0 opacity-70 h-full bg-black top-0 bottom-0"></div>
        <div className="w-[80%] mx-auto absolute inset-0 flex flex-col justify-center items-center text-center z-1 max-md:w-full">
